    ...
    <div class="wrapper center-content">
      ...
      <ul class="inline-grid desktop-one-half mobile-one-second">
        <div class="nav-row">
          ...
          <li class="grid-item right-item main-nav-item has-subnav">
            <a href="#" title="Service & beleid" alt="Service & beleid" class="Service-beleid nav-2017-link">
              <div class="item-content">
                <div class="nav-visual">
        ...
        <div class="nav-row">
          <li class="grid-item main-nav-item">
            <a href="#" title="Thema titel" alt="Thema titel" class="Thema-titel nav-2017-link">
              <div class="item-content">
                <div class="nav-visual">
                  <img src="${asset.get("/html/assets/placeholder-diabetes.jpg")}" alt="Thema titel">
                </div>
                <div class="nav-text">
                  <h3 class="nav-title">Thema titel</h3>
